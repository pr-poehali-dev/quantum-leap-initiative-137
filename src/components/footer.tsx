      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="font-orbitron text-2xl font-bold text-white mb-4">
              Max<span className="text-red-500">Bots</span>
            </h2>
            <p className="font-space-mono text-gray-300 mb-6 max-w-md">
              Создаём ботов и мини-приложения для мессенджера Max. Автоматизируем продажи и сервис для малого бизнеса.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-red-500/20">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="font-space-mono text-gray-400 text-sm">2026 MaxBots. Все права защищены.</p>
